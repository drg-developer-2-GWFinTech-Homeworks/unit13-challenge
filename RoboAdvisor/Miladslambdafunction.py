...
def recommend_portfolio(intent_request):
  ...
  # Gets all the slots
    ...
    initial_recommendation = get_investment_recommandation(risk_level)
...
def validate_data(age, investment_amount):
    ...
    if age is None:
        return build_validation_result(
            False,
            "age",
            "The age must be a number. Please try again."
            )
    elif age <= 0:
        return build_validation_result(
        False,
        "age",
        "The age must be greater than 0. Please try again."
        )
    elif age >=65:
        return build_validation_result(
        False,
        "age",
        "The age must be less than 65. Please try again."
        )
...
def get_investment_recommandation(risk_level):
    if risk_level == "None":
